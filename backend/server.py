...
async def seed_categories():
    ...
    categories = [
        ...
        {"id": "saude-pelos", "name": "Saude dos Pelos", "slug": "saude-pelos", "description": "Produtos naturais e dicas de alimentacao para pelagem brilhante e saudavel. Oleos prensados a frio, suplementos e nutricao.", "image_url": "https://images.unsplash.com/photo-1603890227524-e6f9a790c263?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjAzNzl8MHwxfHNlYXJjaHwyfHxkb2clMjBzaGlueSUyMGNvYXQlMjBncm9vbWluZyUyMGhlYWx0aHklMjBmdXIlMjBwZXR8ZW58MHx8fHwxNzc2MTgyMzA2fDA&ixlib=rb-4.1.0&q=85", "icon": "Sparkles"},
        {"id": "cromoterapia", "name": "Cromoterapia para Pets", "slug": "cromoterapia", "description": "Terapia das cores para equilibrio fisico e emocional do seu pet. Lampadas LED, cristais, agua solarizada e sessoes profissionais.", "image_url": "https://images.unsplash.com/photo-1618018353764-685cb47681d9?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2OTV8MHwxfHNlYXJjaHwzfHxjb2xvciUyMHRoZXJhcHklMjBsaWdodCUyMExFRCUyMHJhaW5ib3clMjBwcmlzbSUyMGhlYWxpbmd8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "icon": "Rainbow"},
...
async def seed_products():
    ...
    products = [
        ...
        # ===== SAUDE DOS PELOS =====
        {"id": "pel-001", "name": "Oleo de Gergelim Prensado a Frio", "description": "Oleo de gergelim puro, prensado a frio, para uso topico e oral. Rico em vitamina E, acidos graxos e antioxidantes. Nutre a pele, fortalece os pelos e promove brilho natural. Uso: adicionar a racao ou aplicar diretamente na pelagem.", "price": 49.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1543416689-e3a7ed4dd3b2?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1Nzl8MHwxfHNlYXJjaHwxfHxzZXNhbWUlMjBvaWwlMjBuYXR1cmFsJTIwY29sZCUyMHByZXNzZWQlMjBib3R0bGUlMjBvcmdhbmljfGVufDB8fHx8MTc3NjE4MjMwNnww&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": True},
        {"id": "pel-002", "name": "Oleo de Coco Extra Virgem para Pets", "description": "Oleo de coco prensado a frio para hidratar pele e pelos. Rico em acido laurico com propriedades antibacterianas e antifungicas. Ideal para pele ressecada e pelagem opaca.", "price": 42.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1552592074-ea7a91b851b3?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1Nzl8MHwxfHNlYXJjaHwzfHxzZXNhbWUlMjBvaWwlMjBuYXR1cmFsJTIwY29sZCUyMHByZXNzZWQlMjBib3R0bGUlMjBvcmdhbmljfGVufDB8fHx8MTc3NjE4MjMwNnww&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "pel-003", "name": "Omega 3-6-9 Veterinario", "description": "Suplemento completo de acidos graxos essenciais para saude da pele e pelagem. Fonte de EPA e DHA de oleo de peixe. Reduz inflamacao e promove pelos sedosos.", "price": 79.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1693996047034-311ab7656691?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjY2NzZ8MHwxfHNlYXJjaHwzfHxvbWVnYSUyMGZpc2glMjBvaWwlMjBzdXBwbGVtZW50JTIwcGV0JTIwbnV0cml0aW9ufGVufDB8fHx8MTc3NjE4MjMwNnww&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": True},
        {"id": "pel-004", "name": "Biotina + Zinco Manipulados", "description": "Formula manipulada com biotina (vitamina B7) e zinco quelatado para fortalecimento de pelos e unhas. Essencial para animais com queda excessiva de pelos.", "price": 55.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1669272454802-011adc62cd9a?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1MTN8MHwxfHNlYXJjaHwyfHx2aXRhbWluJTIwc3VwcGxlbWVudHMlMjBjYXBzdWxlcyUyMGJvdHRsZXN8ZW58MHx8fHwxNzc2MTI5NDU0fDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "pel-005", "name": "Shampoo Natural de Aveia e Aloe Vera", "description": "Shampoo sem sulfatos formulado com aveia coloidal e aloe vera. Acalma peles sensiveis, reduz coceira e deixa a pelagem macia e brilhante.", "price": 38.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1590518563786-901882bf6f82?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1Nzl8MHwxfHNlYXJjaHw0fHxzZXNhbWUlMjBvaWwlMjBuYXR1cmFsJTIwY29sZCUyMHByZXNzZWQlMjBib3R0bGUlMjBvcmdhbmljfGVufDB8fHx8MTc3NjE4MjMwNnww&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "pel-006", "name": "Mix Nutricional Pelagem Brilhante", "description": "Suplemento alimentar em po com linhaca, chia, spirulina e levedura de cerveja. Adicione a racao diariamente para pelagem exuberante e pele saudavel.", "price": 65.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1549530708-be1b34900690?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1Nzl8MHwxfHNlYXJjaHwyfHxzZXNhbWUlMjBvaWwlMjBuYXR1cmFsJTIwY29sZCUyMHByZXNzZWQlMjBib3R0bGUlMjBvcmdhbmljfGVufDB8fHx8MTc3NjE4MjMwNnww&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "pel-007", "name": "Oleo de Linhaça Dourada Prensado a Frio", "description": "Fonte vegetal de Omega 3 (ALA) para saude da pele. Reduz inflamacao, combate dermatites e promove crescimento saudavel dos pelos. Ideal para caes e gatos.", "price": 44.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1662673145204-c843cb1d6ff0?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjY2NzZ8MHwxfHNlYXJjaHwyfHxvbWVnYSUyMGZpc2glMjBvaWwlMjBzdXBwbGVtZW50JTIwcGV0JTIwbnV0cml0aW9ufGVufDB8fHx8MTc3NjE4MjMwNnww&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "pel-008", "name": "Condicionador Leave-in Karite e Argan", "description": "Condicionador sem enxague com manteiga de karite e oleo de argan. Desembaraca, hidrata profundamente e protege a pelagem contra ressecamento.", "price": 45.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1757553532952-401e0b0e9386?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjAzNzl8MHwxfHNlYXJjaHw0fHxkb2clMjBzaGlueSUyMGNvYXQlMjBncm9vbWluZyUyMGhlYWx0aHklMjBmdXIlMjBwZXR8ZW58MHx8fHwxNzc2MTgyMzA2fDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": True},
        {"id": "pel-009", "name": "Kit Pelagem Saudavel Completo", "description": "Kit completo com Oleo de Gergelim, Omega 3-6-9, Biotina+Zinco e Shampoo Natural. Tudo que seu pet precisa para uma pelagem exuberante. Economia de 20%.", "price": 169.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1694372550345-9149dddc390f?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjAzNzl8MHwxfHNlYXJjaHwzfHxkb2clMjBzaGlueSUyMGNvYXQlMjBncm9vbWluZyUyMGhlYWx0aHklMjBmdXIlMjBwZXR8ZW58MHx8fHwxNzc2MTgyMzA2fDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "pel-010", "name": "Racao Natural para Pelagem - Receita Ayurvedica", "description": "Suplemento alimentar inspirado na Ayurveda com curcuma, ashwagandha e ghee para nutrir a pelagem de dentro para fora. Fortalece os foliculos e promove brilho natural.", "price": 89.90, "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1673859360498-0034d111358c?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjAzNzl8MHwxfHNlYXJjaHwxfHxkb2clMjBzaGlueSUyMGNvYXQlMjBncm9vbWluZyUyMGhlYWx0aHklMjBmdXIlMjBwZXR8ZW58MHx8fHwxNzc2MTgyMzA2fDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},

        # ===== CROMOTERAPIA =====
        {"id": "cro-001", "name": "Lampada LED Cromoterapia 7 Cores Pet", "description": "Lampada LED com 7 cores terapeuticas e controle remoto. Cada cor possui vibracao especifica: azul (calmante), verde (equilibrante), vermelho (energizante), amarelo (cicatrizante). Ideal para sessoes de cromoterapia em casa.", "price": 129.90, "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1652759718142-5e6f8ece161c?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2OTV8MHwxfHNlYXJjaHwyfHxjb2xvciUyMHRoZXJhcHklMjBsaWdodCUyMExFRCUyMHJhaW5ib3clMjBwcmlzbSUyMGhlYWxpbmd8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": True},
        {"id": "cro-002", "name": "Bastao Cromatico com Cristal de Quartzo", "description": "Bastao cromatico profissional com ponteira de cristal de quartzo e 12 filtros de cores. Usado por veterinarios para aplicacao pontual de cromoterapia em pontos de acupuntura e areas especificas.", "price": 189.90, "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1663899940839-06ff68bebd50?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjY2NzV8MHwxfHNlYXJjaHw0fHxjcnlzdGFsJTIwaGVhbGluZyUyMHN0b25lcyUyMGNvbG9yZnVsJTIwYW1ldGh5c3QlMjBxdWFydHp8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": True},
        {"id": "cro-003", "name": "Kit Agua Solarizada 7 Cores", "description": "Kit com 7 garrafas de vidro colorido para preparacao de agua solarizada. Cada cor carrega a vibracao da luz solar: azul (relaxamento), verde (imunidade), amarelo (digestao), vermelho (vitalidade). Inclui manual de uso veterinario.", "price": 149.90, "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1597858949210-e255261302fc?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2OTV8MHwxfHNlYXJjaHwxfHxjb2xvciUyMHRoZXJhcHklMjBsaWdodCUyMExFRCUyMHJhaW5ib3clMjBwcmlzbSUyMGhlYWxpbmd8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        ...
        {"id": "cro-005", "name": "Colchonete Cromatico Calmante - Azul", "description": "Colchonete com tecido na tonalidade azul terapeutica para area de descanso do pet. A cor azul promove relaxamento, reduz ansiedade e melhora a qualidade do sono. Tecido antialergico e lavavel.", "price": 89.90, "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1587020439742-866b7cf5bd7c?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2OTV8MHwxfHNlYXJjaHw0fHxjb2xvciUyMHRoZXJhcHklMjBsaWdodCUyMExFRCUyMHJhaW5ib3clMjBwcmlzbSUyMGhlYWxpbmd8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "cro-006", "name": "Sessao de Cromoterapia Veterinaria", "description": "Sessao profissional de cromoterapia com veterinario especialista. Inclui avaliacao energetica, aplicacao de cores terapeuticas com bastao cromatico e lampada LED, e plano de tratamento personalizado.", "price": 180.00, "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1618018353764-685cb47681d9?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2OTV8MHwxfHNlYXJjaHwzfHxjb2xvciUyMHRoZXJhcHklMjBsaWdodCUyMExFRCUyMHJhaW5ib3clMjBwcmlzbSUyMGhlYWxpbmd8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": True},
        {"id": "cro-007", "name": "Pacote 5 Sessoes de Cromoterapia", "description": "Pacote com 5 sessoes de cromoterapia veterinaria com 15% de desconto. Inclui acompanhamento semanal e ajuste de cores conforme evolucao do tratamento.", "price": 765.00, "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1585383234137-2367d3c5302d?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjY2NzV8MHwxfHNlYXJjaHwyfHxjcnlzdGFsJTIwaGVhbGluZyUyMHN0b25lcyUyMGNvbG9yZnVsJTIwYW1ldGh5c3QlMjBxdWFydHp8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "cro-008", "name": "Luminaria Terapeutica Noturna para Pets", "description": "Luminaria com luz suave em tons de azul e violeta para uso noturno. Reduz insonia, ansiedade noturna e medo de fogos de artificio. Sensor de luminosidade automatico e consumo minimo de energia.", "price": 79.90, "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1641997644736-e4f82b939e71?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjY2NzV8MHwxfHNlYXJjaHwxfHxjcnlzdGFsJTIwaGVhbGluZyUyMHN0b25lcyUyMGNvbG9yZnVsJTIwYW1ldGh5c3QlMjBxdWFydHp8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "cro-009", "name": "Oleo Essencial Cromatico Verde - Equilibrio", "description": "Blend de oleos essenciais associado a vibracao da cor verde (eucalipto, alecrim, horteña). Para uso em difusor no ambiente do pet. Promove equilibrio, alivia dores respiratorias e estimula imunidade.", "price": 59.90, "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1552592074-ea7a91b851b3?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1Nzl8MHwxfHNlYXJjaHwzfHxzZXNhbWUlMjBvaWwlMjBuYXR1cmFsJTIwY29sZCUyMHByZXNzZWQlMjBib3R0bGUlMjBvcmdhbmljfGVufDB8fHx8MTc3NjE4MjMwNnww&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": False},
        {"id": "cro-010", "name": "Kit Cromoterapia Completo para Casa", "description": "Kit completo para praticar cromoterapia em casa: Lampada LED 7 cores, kit agua solarizada, 7 cristais terapeuticos, luminaria noturna e manual ilustrado de cromoterapia veterinaria. Economia de 20%.", "price": 399.90, "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1652759718142-5e6f8ece161c?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2OTV8MHwxfHNlYXJjaHwyfHxjb2xvciUyMHRoZXJhcHklMjBsaWdodCUyMExFRCUyMHJhaW5ib3clMjBwcmlzbSUyMGhlYWxpbmd8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "in_stock": True, "featured": True},
    ]
...
async def seed_tips():
    ...
    tips = [
        ...
        {"id": "tip-5", "title": "Oleo de Gergelim: O Segredo para Pelos Brilhantes", "excerpt": "Descubra como o oleo de gergelim prensado a frio pode transformar a pelagem do seu pet, nutrindo de dentro para fora.", "content": "O oleo de gergelim prensado a frio e um dos segredos mais antigos da Ayurveda para saude da pele e dos pelos. Rico em vitamina E, acidos graxos essenciais (omega 6 e 9), sesamina e sesamolina (antioxidantes exclusivos), ele nutre profundamente os foliculos pilosos, fortalece a fibra capilar e cria uma barreira protetora natural contra ressecamento. Na medicina ayurvedica, o gergelim e considerado um alimento 'sattvico' — que promove equilibrio e vitalidade. Para uso em pets, recomenda-se adicionar 1 colher de cha (caes pequenos) a 1 colher de sopa (caes grandes) na racao diariamente. Tambem pode ser aplicado topicamente com massagem suave para hidratar areas ressecadas. Alem do gergelim, outros oleos como coco, linhaca e argan complementam o tratamento. A alimentacao e fundamental: proteinas de qualidade, zinco, biotina e acidos graxos sao os pilares para uma pelagem exuberante.", "author": "Dra. Juliana Ferreira", "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1603890227524-e6f9a790c263?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjAzNzl8MHwxfHNlYXJjaHwyfHxkb2clMjBzaGlueSUyMGNvYXQlMjBncm9vbWluZyUyMGhlYWx0aHklMjBmdXIlMjBwZXR8ZW58MHx8fHwxNzc2MTgyMzA2fDA&ixlib=rb-4.1.0&q=85", "date": "2026-01-10", "read_time": "10 min"},
        {"id": "tip-6", "title": "Alimentacao Natural para Pelagem Saudavel", "excerpt": "Saiba quais alimentos naturais incluir na dieta do seu pet para pelos fortes, brilhantes e saudaveis.", "content": "A saude da pelagem comeca no prato. Uma dieta rica em proteinas de alta qualidade (como frango, peixe e ovos) fornece os aminoacidos essenciais para a formacao da queratina, principal componente dos pelos. Acidos graxos omega 3 (encontrados em peixes como salmao e sardinha) e omega 6 (presentes em oleos vegetais como gergelim e linhaca) sao fundamentais para manter a pele hidratada e os pelos brilhantes. Vitaminas do complexo B, especialmente a biotina (B7), sao cruciais para o ciclo de crescimento capilar. O zinco participa diretamente na sintese de queratina. Alimentos como cenoura, abobora e batata-doce fornecem betacaroteno, que o organismo converte em vitamina A — essencial para a renovacao celular da pele. Dica pratica: adicione uma colher de oleo de gergelim prensado a frio ou de linhaca a racao do seu pet diariamente.", "author": "Dra. Carolina Mendes", "category": "saude-pelos", "image_url": "https://images.unsplash.com/photo-1623099354893-9a1fbd0dbb3f?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjAzMzl8MHwxfHNlYXJjaHwzfHxjYmQlMjBvaWwlMjBkcm9wcGVyJTIwcGV0JTIwd2VsbG5lc3N8ZW58MHx8fHwxNzc2MTI5NDU0fDA&ixlib=rb-4.1.0&q=85", "date": "2026-02-05", "read_time": "8 min"},
        {"id": "tip-7", "title": "Cromoterapia para Pets: Guia Completo das Cores que Curam", "excerpt": "Descubra como a terapia das cores pode transformar a saude fisica e emocional do seu animal de estimacao.", "content": "A cromoterapia e uma terapia complementar reconhecida pela OMS desde 1976 que utiliza a vibracao das cores do espectro solar para restabelecer o equilibrio fisico e energetico. Na veterinaria integrativa, cada cor possui efeitos especificos: o AZUL tem efeito calmante e analgesico — ideal para animais ansiosos, com insonia ou dores. O VERDE e equilibrante, alivia patologias respiratorias e estimula o sistema imunologico. O VERMELHO aumenta a energia vital e auxilia em casos de depressao e anemia (contraindicado para animais agressivos). O AMARELO estimula a cicatrizacao e regeneracao tecidual, beneficiando o sistema digestivo. O LARANJA e vitalizante, usado para fadiga e problemas reprodutivos. O ROSA promove bem-estar e tranquilidade sem contraindicacoes. A aplicacao pode ser feita com lampadas LED coloridas, bastoes cromaticos com cristal, agua solarizada (agua exposta ao sol em garrafas coloridas) ou tecidos e acessorios na cor terapeutica. Os animais frequentemente escolhem instintivamente a cor que necessitam — observe se seu pet e atraido por determinadas cores. Sessoes de 15 a 30 minutos, 2 a 3 vezes por semana, ja mostram resultados. A cromoterapia e especialmente eficaz quando combinada com outras terapias integrativas como acupuntura, homeopatia e florais.", "author": "Dr. Paulo Henrique Viana", "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1618018353764-685cb47681d9?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2OTV8MHwxfHNlYXJjaHwzfHxjb2xvciUyMHRoZXJhcHklMjBsaWdodCUyMExFRCUyMHJhaW5ib3clMjBwcmlzbSUyMGhlYWxpbmd8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "date": "2026-03-12", "read_time": "12 min"},
        {"id": "tip-8", "title": "Agua Solarizada: Como Preparar e Usar no seu Pet", "excerpt": "Aprenda a preparar agua solarizada em casa e como cada cor beneficia a saude do seu animal.", "content": "A agua solarizada e uma das formas mais simples e acessiveis de aplicar cromoterapia no dia a dia do seu pet. O preparo e simples: coloque agua mineral em uma garrafa de vidro da cor desejada e deixe exposta a luz solar direta por 2 a 4 horas. A agua absorve a vibracao da cor e pode ser oferecida ao animal para beber ou usada para banhos e compressas. AGUA AZUL: a mais utilizada — acalma ansiedade, reduz inflamacoes, melhora o sono. Ofereca como agua de beber para pets ansiosos ou apos situacoes de estresse. AGUA VERDE: equilibra o organismo, fortalece imunidade. Ideal para pets em recuperacao de doencas. AGUA AMARELA: estimula digestao e apetite. Excelente para animais inapetentes. AGUA VERMELHA: aumenta energia e vitalidade. Para animais debilitados ou com anemia (usar com cautela). A agua solarizada nao substitui tratamento veterinario convencional, mas e um complemento seguro e natural. Armazene na geladeira por ate 24 horas.", "author": "Dra. Renata Campos", "category": "cromoterapia", "image_url": "https://images.unsplash.com/photo-1597858949210-e255261302fc?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2OTV8MHwxfHNlYXJjaHwxfHxjb2xvciUyMHRoZXJhcHklMjBsaWdodCUyMExFRCUyMHJhaW5ib3clMjBwcmlzbSUyMGhlYWxpbmd8ZW58MHx8fHwxNzc2MTgzNzExfDA&ixlib=rb-4.1.0&q=85", "date": "2026-03-20", "read_time": "9 min"}
    ]
