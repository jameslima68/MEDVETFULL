        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {['Homeopatia', 'Hormônios Bioidênticos', 'Medicina Chinesa', 'CBD para Pets', 'Acupuntura', 'Saúde dos Pelos', 'Cromoterapia'].map(item => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><Link to="/missao" className="text-sm text-[#F9F6F0]/60 hover:text-[#F9F6F0] transition-colors">Nossa Missão</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <a href="https://www.tiktok.com/@medvet.integrativa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[#F9F6F0]/60 hover:text-[#F9F6F0] transition-colors">
                  <Music2 className="w-4 h-4 flex-shrink-0" /> @medvet.integrativa
                </a>
              </li>
            </ul>
          </div>
