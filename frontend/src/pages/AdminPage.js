              ...
              <div className="bg-white/80 border border-[#E0DDD5] rounded-2xl p-6 mb-6 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <select value={productForm.category} onChange={e => setProductForm(f => ({...f, category: e.target.value}))} className={inputCls}>
                    <option value="homeopatia">Homeopatia</option><option value="hormonios">Hormonios</option><option value="medicina-chinesa">Medicina Chinesa</option><option value="cbd">CBD</option><option value="acupuntura">Acupuntura</option>
                  </select>
